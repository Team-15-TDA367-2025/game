...
public class FogRenderer {
    ...
    public void render(FogOfWar fogOfWar, Matrix4 worldProjectionMatrix, CameraView cameraView) {
        ...
        renderFogMask(fogOfWar, worldProjectionMatrix);
        
        // Step 2: Render the fog overlay in SCREEN SPACE with shader
        renderFogOverlay(screenWidth, screenHeight, cameraView);
    }
    
    private void renderFogMask(FogOfWar fogOfWar, Matrix4 worldProjectionMatrix) {
        fogMaskBuffer.begin();
    ...
    private void renderFogOverlay(int screenWidth, int screenHeight, CameraView cameraView) {
        ...
        // Use SCREEN SPACE projection (0,0 to screenWidth,screenHeight)
