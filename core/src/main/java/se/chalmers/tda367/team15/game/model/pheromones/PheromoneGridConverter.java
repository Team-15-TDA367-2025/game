...
/**
 * Utility class for converting between world coordinates and pheromone grid coordinates.
...
public class PheromoneGridConverter {
    ...
    /**
     * Converts pheromone grid coordinates to world coordinates (center of pheromone cell).
